...
const showEditUserModal = (docId: string) => {
    userDocId.value = docId
    modalRef.value.openModal('EditUserModal');
};
            ...
            <table class="w-full text-sm text-left">
                ...
                <tbody>
                    <tr class="border-b" v-for="user in users">
                        ...
                        <td class="px-6 py-4 text-center">
                            <button @click="showEditUserModal(user.docId)" class="m-2"><svg
